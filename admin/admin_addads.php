<?php
	...
	{
         $editId=$_GET['editID'];
		 $sql="select * from ads2 where Id_ads='$editId'";
		...
		<div class="panel panel-default" style="margin-bottom:0px;">
		         ...
		         <div class="panel panel-info" style="width:100%;position:relative;font-size:1.2em;">
                         <div class="panel-heading">
                           ...
                           <?php if(isset($_GET['editID'])) echo 'Advertisement Details';
						   else echo 'Add advertisements';
						   ?>
						   	<a href="admin_newslist.php"><input type="submit" style="background-color:#008000;float:right;"value="Back to Advertisement Table"  class="btn btn-info"/></a>
                        </div>
		    ...
		    // echo '<script type="text/javascript"> alert("Submit button clicked'.$editId.'")</script>'; // kur shtyp submit del alert qe sapo e ke shtypur butonin
			          if(getimagesize($_FILES['image']['tmp_name'])) 
					 {
                      ...
                      $desc=$_POST['desc'];  
						...
						$reklame->redirect("admin_newslist.php");
