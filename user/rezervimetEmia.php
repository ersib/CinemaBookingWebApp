  ...
  <h3><strong>The table of <?php echo $username?> 's bookings</strong> </h3><br><br>
			   ...
			   <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive" id="tabelaRez">
							<?php
...
<th>Total Price</th><th>Status</th><th>Reservation Date</th></tr></thead><tbody>';
                ...
                if($lista_rez[$i]['Statusi']=="DONE"){
								$msg.='<td><a href="rezervimetEmia.php?deletID='.$lista_rez[$i]['Id_rezervim'].'"><input type="button" name="submit" value="Cancel"
								style="background-color:red;padding:5px;"/></a></td>';
							}
								$msg.'</tr>';
							}
						}
